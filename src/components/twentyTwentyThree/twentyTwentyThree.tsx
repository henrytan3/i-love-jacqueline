  ...
  return (
    <>
      <StyledStack
        ...
        content={
          <Box boxSize={boxSizes} mb="10em">
            <Image loading="lazy" fallbackSrc={pompomCookie} src={birthday} />
          </Box>
        }
        text={
          <>
      ...
      <StyledStack
        ...
        content={
          <SimpleGrid columns={{ base: 1, sm: 1, lg: 2 }} gap={4}>
            <Box boxSize={boxSizes} mb="8em">
              <Image loading="lazy" src={homeokase1} />
            </Box>
            <Box boxSize={boxSizes} mb="8em">
              <Image src={homeokase2} />
            </Box>
            <Box boxSize={boxSizes} mb="8em">
              <Image src={homeokase3} />
            </Box>
            <Box boxSize={boxSizes} mb="8em">
              <Image src={homeokase4} />
            </Box>
          </SimpleGrid>
        }
        text={
      ...
      <StyledStack
        ...
        content={
          <Box boxSize={boxSizes} mb="10em">
            <Image loading="lazy" src={upstairsCircus} />
          </Box>
        }
        text={
          <>
      ...
      <StyledStack
        ...
        content={
          <Box boxSize={boxSizes} mb="10em">
            <Image loading="lazy" src={ghibliConcert} />
          </Box>
        }
        text={
          <>
      ...
      <StyledStack
        ...
        content={
          <SimpleGrid columns={{ base: 1, sm: 1, lg: 2 }} gap={4}>
            <Box boxSize={boxSizes} mb="8em">
              <Image src={oneYearDinner} />
            </Box>
            <Box boxSize={boxSizes} mb="8em">
              <Image src={oneYearFlowers} />
            </Box>
          </SimpleGrid>
        }
        text={
          <>
            ...
            <br />
            I didn't get any pictures of us, but that's ok there's more to come!{' '}
            <br />
      ...
      <StyledStack
        ...
        content={
          <SimpleGrid columns={{ base: 1, sm: 1, lg: 2 }} gap={4}>
            <Box boxSize={boxSizes} mb="8em">
              <Image loading="lazy" src={illenium1} />
            </Box>
            <Box boxSize={boxSizes} mb="8em">
              <Image loading="lazy" src={illenium2} />
            </Box>
          </SimpleGrid>
        }
        text={
      ...
      <StyledStack
        ...
        content={
          <SimpleGrid columns={{ base: 1, sm: 1, lg: 2 }} gap={4}>
            <Box boxSize={boxSizes} mb="8em">
              <Image loading="lazy" src={puttShack1} />
            </Box>
            <Box boxSize={boxSizes} mb="8em">
              <Image loading="lazy" src={puttShack2} />
            </Box>
          </SimpleGrid>
        }
        text={
      ...
      <StyledStack
        ...
        content={
          <Box boxSize={boxSizes} mb="2em">
            <Image loading="lazy" src={artMuseum} />
          </Box>
        }
        text={
          <>
            ...
            <br />
            Out of all the art work, you were the most beautiful masterpiece
            baby! 😍
          </>
        }
      ></StyledStack>
      <StyledStack
        ...
        content={
          <Box boxSize={boxSizes} mb="10em">
            <Image loading="lazy" src={brightLights} />
          </Box>
        }
        text={
          <>
      ...
      <StyledStack
        ...
        content={
          <Box boxSize={boxSizes} mb="10em">
            <Image loading="lazy" src={cuonAndCheesecake} />
          </Box>
        }
        text={
          <>
      ...
      <StyledStack
        ...
        content={
          <Box boxSize={boxSizes} mb="10em">
            <Image loading="lazy" src={vyBirthday} />
          </Box>
        }
        text={
          <>
            ...
            <br />
            You are honestly the most loving, kind, and beautiful girl in the
            world! <br />
      ...
      <StyledStack
        ...
        content={
          <SimpleGrid columns={{ base: 1, sm: 1, lg: 1 }} gap={4}>
            <Box style={{ marginBottom: '0px' }} boxSize={boxSizes} mb="8em">
              <Image loading="lazy" src={museumOfIllusions2} />
            </Box>
            <Box boxSize={boxSizes} mb="8em">
              <Image loading="lazy" src={museumOfIllusions1} />
            </Box>
          </SimpleGrid>
        }
        text={
